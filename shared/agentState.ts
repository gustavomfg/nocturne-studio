...
const transitions: Record<AgentState, ReadonlySet<AgentState>> = {
  ...
  planning: new Set(['ready', 'running', 'waiting-approval', 'completed', 'cancelling', 'failed', 'disconnected']),
  running: new Set(['ready', 'waiting-approval', 'cancelling', 'completed', 'failed', 'disconnected']),
  'waiting-approval': new Set(['ready', 'running', 'cancelling', 'failed', 'disconnected']),
