export const IPC_CHANNELS = {
  ...
  engineeringIntelligence: { report: 'engineeringIntelligence:report', changed: 'engineeringIntelligence:changed' },
  validation: { run: 'validation:run', cancel: 'validation:cancel', list: 'validation:list', page: 'validation:page', latest: 'validation:latest', changed: 'validation:statusChanged' },
  changeControl: { get: 'changeControl:get', changes: 'changeControl:changes', diff: 'changeControl:diff', hunks: 'changeControl:hunks', editHunk: 'changeControl:editHunk', decideHunk: 'changeControl:decideHunk', decide: 'changeControl:decide', changed: 'changeControl:changed' },
