...
function App() {
  ...
  useEffect(() => {
    const shortcuts = (event: KeyboardEvent) => {
      if (event.key === '?' && !isTextEntryTarget(event.target) && !document.querySelector('[aria-modal="true"]')) { event.preventDefault(); setHelpOpen(true); return }
