...
const RATE_LIMITS: Partial<Record<IpcChannel, RateLimitConfig>> = {
  ...
  'projectIndex:start': { windowMs: 10_000, maxCalls: 3 },
  'projectIndex:retry': { windowMs: 10_000, maxCalls: 3 },
  'validation:run': { windowMs: 10_000, maxCalls: 5 },
  'validation:cancel': { windowMs: 2_000, maxCalls: 10 },
  'data:import': { windowMs: 30_000, maxCalls: 2 },
  'data:export': { windowMs: 30_000, maxCalls: 5 },
  'updates:check': { windowMs: 10_000, maxCalls: 3 },
  'updates:download': { windowMs: 10_000, maxCalls: 3 },
  'updates:retry': { windowMs: 10_000, maxCalls: 3 },
  'updates:install': { windowMs: 10_000, maxCalls: 2 },
